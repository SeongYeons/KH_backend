...
<body>
	...
	<p>
		...
		표현식 태그를 대신하여 클라이언트에 출력하고자 하는 값들을 좀 더
		간결하게 출력할 수 있다.  
	</p>
	...
	<p>
		JSP에서 자주 사용하는 코드들을 사용하기 쉽게 태그로 만들어 제공한다.
	</p>
	
	<h5>2-1) JSTL Core Library</h5>
	<p>
		변수, 조건문, 반복문 등의 로직과 관련된 액션 태그를 제공한다.
	</p>
	...
	<p>
		문자열 처리에 관련된 메소드들을 EL 구문에서 사용할 수 있게 하는 라이브러리이다.
	</p>
